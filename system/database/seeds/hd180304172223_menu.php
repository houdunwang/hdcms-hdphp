...
class hd180304172223_menu extends Seeder
{
    //执行
    public function up()
    {
        Db::table('menu')->where('is_system', 1)->delete();
        $sql
            = <<<sql
...
VALUES
	...
	(64, 63, '微信支付', 'feature_setting_pay', '?s=site/setting/wepay', '', 'fa fa-cubes', 0, 1, 1, 'feature'),
	...
	(85, 78, '微站快捷导航', 'feature_quick_menu', '?m=quickmenu&action=controller/admin/post', '', 'fa fa-cubes', 0, 1, 1, 'feature'),
	...
	(104, 63, '支付宝', 'feature_setting_alipay', '?s=site/setting/alipay', '', 'fa fa-cubes', 0, 1, 1, 'feature'),
