    ...
    <div class="container-fluid">
        ...
        <form method="post" class="form-horizontal" role="form" onsubmit="post(event)">
            <div class="form-group">
                <div class="col-sm-12">
                    <input type="text" class="form-control input-lg" required name="username"
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <input type="password" name="password" class="form-control input-lg"
                           placeholder="请输入不少于5位的密码" required="required"/>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
                    <input type="password" name="cpassword" class="form-control input-lg"
                           placeholder="请再次输入密码" required="required"/>
                </div>
            </div>
            <if value="v('site.setting.register.auth')">
                <div class="form-group">
                    <div class="col-sm-12">
                        <div class="input-group input-group-lg">
                            <input class="form-control" placeholder="请输入验证码" name="valid_code"
                                   required="required">
                            <span class="input-group-btn">
                        <button class="btn btn-default" type="button"
                                id="sendValidCode">发送验证码</button>
                    </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="icon">
                        <ul class="row">
                            <?php for ($i = 1; $i <= 24; $i++): ?>
                                <li class="col-xs-3"
                                    onclick="selectIcon('resource/images/icon/{{$i}}.jpg',this)">
                                    <img src="{{root_url()}}/resource/images/icon/{{$i}}.jpg"
                                         alt="">
                                </li>
                            <?php endfor; ?>
                        </ul>
