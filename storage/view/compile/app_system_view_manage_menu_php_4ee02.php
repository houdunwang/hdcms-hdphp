...
<div>
    ...
    <?php if ($user->isSuperUser()): ?>
        ...
        <div class="clearfix">
            <a href="<?php echo  u('system/cloud/upgrade') ?>" class="tile img-rounded">
                <i class="fa fa-cloud-download"></i>
                <span>一键更新</span>
            </a>
            <a href="<?php echo  u('system/cloud/account') ?>" class="tile img-rounded">
    ...
    <div class="clearfix">
        ...
        <?php if ($user->isSuperUser()): ?>
            <a href="<?php echo  u('system/user/lists') ?>" class="tile img-rounded">
                <i class="fa fa-user"></i>
                <span>用户管理</span>
            </a>
            <a href="<?php echo  u('system/group/lists') ?>" class="tile img-rounded">
                <i class="fa fa-users"></i>
                <span>用户组管理</span>
            </a>
            <a href="<?php echo  u('system/config/register') ?>" class="tile img-rounded">
