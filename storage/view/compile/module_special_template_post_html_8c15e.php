                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group" id="welcome">
                            <input type="text" class="form-control" name="welcome" value="<?php echo htmlspecialchars(v('site.setting.welcome'))?>" placeholder="可根据关键字直接关联指定的回复规则">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group" id="default">
                            <input type="text" class="form-control" name="default" value="<?php echo htmlspecialchars(v('site.setting.default_message'))?>" placeholder="可根据关键字直接关联指定的回复规则">
                            <ul class="dropdown-menu" style="width:92%;"></ul>
                            <span class="input-group-btn">
