...
<div>
	...
	<div class="panel panel-default">
		...
		<table class="table table-bordered table-hover">
			...
			<tr>
				<td>模型</td>
				<td><?php echo htmlspecialchars(Db::table('web_model')->where('siteid',SITEID)->count())?></td>
			</tr>
			<tr>
				<td>栏目</td>
				<td><?php echo htmlspecialchars(Db::table('web_category')->where('siteid',SITEID)->count())?></td>
			</tr>
			</tbody>
		</table>
	</div>
	<div class="panel panel-default">
		...
		<table class="table table-bordered table-hover">
			...
			<tr>
				...
				<?php if(is_array($domains) || is_object($domains)){foreach ($domains as $domain){?>
					<td>
						<a href="<?php echo htmlspecialchars($domain)?>" target="_blank"><?php echo htmlspecialchars($domain)?></a>
					</td>
				<?php }}?>
