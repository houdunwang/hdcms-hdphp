...
<div>
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li><a href="<?php echo  url('slide.lists',array('webid'=>$_GET['webid'])) ?>">轮换图片管理</a></li>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" required class="form-control" name="displayorder" value="<?php echo htmlspecialchars($field['displayorder']?:0)?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label star">标题</label>
                    <div class="col-sm-8">
                        <input class="form-control" required name="title" value="<?php echo htmlspecialchars($field['title'])?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input class="form-control" readonly="readonly" required title="请选择图片" name="thumb" value="<?php echo htmlspecialchars($field['thumb'])?>">
                        ...
                        <div class="input-group" style="margin-top:5px;">
                            <img src="<?php echo htmlspecialchars(pic($field['thumb']))?>" class="img-responsive img-thumbnail" width="150">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input class="form-control" required id="url" name="url" value="<?php echo htmlspecialchars($field['url'])?>">
                            <div class="input-group-btn">
...
<script>
    ...
    function post(event) {
        ...
        require(['hdjs'], function (hdjs) {
            hdjs.submit({successUrl:"<?php echo  url('slide.lists') ?>"});
        });
    }
